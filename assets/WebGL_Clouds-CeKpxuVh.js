import{e as v,d as p,f as d,b as h,i as x,j as y,k as g,l as q,F as _}from"./utils-E6iCwlZp.js";const w=`
...
`,e={program:null,uniforms:{},time:0,mouseX:.5,mouseY:.3};function z({ctx:a,canvas:c,data:r,performanceMode:n=!1,beatIntensity:t=0,bass:i=0,mid:s=0}){if(!v(c.width,c.height))return;const m=p(),o=y();if(!o)return;if(!e.program){if(e.program=d(o,_,w),!e.program)return;e.uniforms=h(o,e.program)}if(x(),!e.program)return;e.time+=(n?.012:.016)*(1+i*.3),e.mouseX+=3e-4,e.mouseY=.3+Math.sin(e.time*.1)*.1;const f=r.reduce((l,u)=>l+u,0)/r.length;o.viewport(0,0,o.drawingBufferWidth,o.drawingBufferHeight),o.clearColor(0,0,0,0),o.clear(o.COLOR_BUFFER_BIT),o.useProgram(e.program),o.uniform1f(e.uniforms.u_time,e.time),o.uniform1f(e.uniforms.u_intensity,f),o.uniform1f(e.uniforms.u_beatIntensity,t),o.uniform1f(e.uniforms.u_bass,i),o.uniform1f(e.uniforms.u_mid,s),o.uniform2f(e.uniforms.u_resolution,c.width,c.height),o.uniform2f(e.uniforms.u_mouse,e.mouseX%1,e.mouseY%1),o.enable(o.BLEND),o.blendFunc(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA),g(e.program),q(m,a,c)}function S(){e.program=null,e.uniforms={}}export{S as cleanup,z as default};
