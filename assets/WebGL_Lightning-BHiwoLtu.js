import{e as d,d as v,f as g,b as _,i as y,j as w,k as x,l as S,F as k}from"./utils-E6iCwlZp.js";const C=`
...
`,o={program:null,uniforms:{},time:0,lastBeat:0};function L({ctx:u,canvas:a,data:i,performanceMode:c=!1,beatIntensity:f=0,bass:m=0,high:h=0}){if(!d(a.width,a.height))return;const b=v(),t=w();if(!t)return;if(!o.program){if(o.program=g(t,k,C),!o.program)return;o.uniforms=_(t,o.program)}if(y(),!o.program)return;o.time+=c?.012:.016,f>.5&&(o.lastBeat=o.time);const p=i.reduce((e,l)=>e+l,0)/i.length,s=new Float32Array(8),n=Math.floor(i.length/8);for(let e=0;e<8;e++){let l=0;for(let r=0;r<n;r++)l+=i[e*n+r]||0;s[e]=l/n}t.viewport(0,0,t.drawingBufferWidth,t.drawingBufferHeight),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT),t.useProgram(o.program),t.uniform1f(o.uniforms.u_time,o.time),t.uniform1f(o.uniforms.u_intensity,p),t.uniform1f(o.uniforms.u_beatIntensity,f),t.uniform1f(o.uniforms.u_bass,m),t.uniform1f(o.uniforms.u_high,h),t.uniform2f(o.uniforms.u_resolution,a.width,a.height),t.uniform1fv(o.uniforms["u_frequencies[0]"],s),t.uniform1f(o.uniforms.u_lastBeat,o.lastBeat),t.enable(t.BLEND),t.blendFunc(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA),x(o.program),S(b,u,a)}function A(){o.program=null,o.uniforms={}}export{A as cleanup,L as default};
