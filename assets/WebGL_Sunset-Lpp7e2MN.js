import{d as u,e as v,b as m,s as p,f as g,i as h,r as x,F as y}from"./utils-BleFf0sD.js";const _=`
...
`,e={program:null,uniforms:{},initialized:!1,lastCanvas:null,glCanvas:null,time:0};function C({ctx:i,canvas:o,data:t,performanceMode:r=!1,beatIntensity:n=0,bass:s=0,mid:d=0}){(!e.glCanvas||e.lastCanvas!==o)&&(e.glCanvas=document.createElement("canvas"),e.initialized=!1),(e.glCanvas.width!==o.width||e.glCanvas.height!==o.height)&&(e.glCanvas.width=o.width,e.glCanvas.height=o.height,e.initialized=!1);const a=u(e.glCanvas);if(!a)return;if(!e.initialized){if(e.program=v(a,y,_),!e.program)return;e.uniforms=m(a,e.program),p(a),e.initialized=!0,e.lastCanvas=o}if(!e.program)return;e.time+=r?.012:.016;const l=t.reduce((c,f)=>c+f,0)/t.length;a.viewport(0,0,a.drawingBufferWidth,a.drawingBufferHeight),a.clearColor(0,0,0,0),a.clear(a.COLOR_BUFFER_BIT),a.useProgram(e.program),a.uniform1f(e.uniforms.u_time,e.time),a.uniform1f(e.uniforms.u_intensity,l),a.uniform1f(e.uniforms.u_beatIntensity,n),a.uniform1f(e.uniforms.u_bass,s),a.uniform1f(e.uniforms.u_mid,d),a.uniform2f(e.uniforms.u_resolution,o.width,o.height),a.enable(a.BLEND),a.blendFunc(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA),g(a,e.program),h(e.glCanvas,i,o)}function w(){e.glCanvas&&(x(e.glCanvas),e.glCanvas=null,e.program=null,e.initialized=!1,e.lastCanvas=null)}export{w as cleanup,C as default};
