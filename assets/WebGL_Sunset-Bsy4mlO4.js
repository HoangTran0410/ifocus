import{e as v,d as m,f as p,b as h,i as g,j as x,k as y,l as _,F as b}from"./utils-E6iCwlZp.js";const S=`
...
`,o={program:null,uniforms:{},time:0};function C({ctx:i,canvas:a,data:r,performanceMode:n=!1,beatIntensity:d=0,bass:t=0,mid:s=0}){if(!v(a.width,a.height))return;const c=m(),e=x();if(!e)return;if(!o.program){if(o.program=p(e,b,S),!o.program)return;o.uniforms=h(e,o.program)}if(g(),!o.program)return;o.time+=(n?.012:.016)*(1+t*.1);const f=r.reduce((l,u)=>l+u,0)/r.length;e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.useProgram(o.program),e.uniform1f(o.uniforms.u_time,o.time),e.uniform1f(o.uniforms.u_intensity,f),e.uniform1f(o.uniforms.u_beatIntensity,d),e.uniform1f(o.uniforms.u_bass,t),e.uniform1f(o.uniforms.u_mid,s),e.uniform2f(o.uniforms.u_resolution,a.width,a.height),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),y(o.program),_(c,i,a)}function k(){o.program=null,o.uniforms={}}export{k as cleanup,C as default};
