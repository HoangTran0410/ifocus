import{d as c,e as m,b as v,s as g,f as h,i as _,r as y,F as b}from"./utils-BleFf0sD.js";const C=`
...
`,t={program:null,uniforms:{},initialized:!1,lastCanvas:null,glCanvas:null,time:0,mouseX:0,mouseY:0};function w({ctx:l,canvas:a,data:o,performanceMode:i=!1,beatIntensity:n=0,bass:s=0,mid:f=0,high:r=0}){(!t.glCanvas||t.lastCanvas!==a)&&(t.glCanvas=document.createElement("canvas"),t.initialized=!1),(t.glCanvas.width!==a.width||t.glCanvas.height!==a.height)&&(t.glCanvas.width=a.width,t.glCanvas.height=a.height,t.initialized=!1);const e=c(t.glCanvas);if(!e)return;if(!t.initialized){if(t.program=m(e,b,C),!t.program)return;t.uniforms=v(e,t.program),g(e),t.initialized=!0,t.lastCanvas=a}if(!t.program)return;t.time+=(i?.012:.016)*(1+s*.3),t.mouseX=Math.sin(t.time*.1)*.3,t.mouseY=Math.cos(t.time*.15)*.2;const p=o.reduce((u,d)=>u+d,0)/o.length;e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.useProgram(t.program),e.uniform1f(t.uniforms.u_time,t.time),e.uniform1f(t.uniforms.u_intensity,p),e.uniform1f(t.uniforms.u_beatIntensity,n),e.uniform1f(t.uniforms.u_bass,s),e.uniform1f(t.uniforms.u_mid,f),e.uniform1f(t.uniforms.u_high,r),e.uniform2f(t.uniforms.u_resolution,a.width,a.height),e.uniform2f(t.uniforms.u_mouse,t.mouseX,t.mouseY),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),h(e,t.program),_(t.glCanvas,l,a)}function x(){t.glCanvas&&(y(t.glCanvas),t.glCanvas=null,t.program=null,t.initialized=!1,t.lastCanvas=null)}export{x as cleanup,w as default};
