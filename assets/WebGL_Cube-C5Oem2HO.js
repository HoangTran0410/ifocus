import{e as p,d,f as g,b as y,i as _,j as h,k as v,l as b,F as C}from"./utils-E6iCwlZp.js";const R=`
...
`,r={program:null,uniforms:{},time:0};function w({ctx:a,canvas:o,data:n,performanceMode:t=!1,beatIntensity:i=0,bass:s=0,mid:l=0}){if(!p(o.width,o.height))return;const u=d(),e=h();if(!e)return;if(!r.program){if(r.program=g(e,C,R),!r.program)return;r.uniforms=y(e,r.program)}if(_(),!r.program)return;r.time+=t?.012:.016;const f=n.reduce((c,m)=>c+m,0)/n.length;e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.useProgram(r.program),e.uniform1f(r.uniforms.u_time,r.time),e.uniform1f(r.uniforms.u_intensity,f),e.uniform1f(r.uniforms.u_beatIntensity,i),e.uniform1f(r.uniforms.u_bass,s),e.uniform1f(r.uniforms.u_mid,l),e.uniform2f(r.uniforms.u_resolution,o.width,o.height),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),v(r.program),b(u,a,o)}function x(){r.program=null,r.uniforms={}}export{x as cleanup,w as default};
